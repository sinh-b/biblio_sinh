...
/**
 * 
 * @param idExemplaire l'identifiant permettant de trouver un exemplaire dans la base de donn�es.
 * @return Un E
 * 
 * xemplaire en fonction de l'identifiant pass� en param�tre
 * 
 */
...
/**
 * 
 * @param status Le statut d'exemplaires que l'on cherche � trouver (DISPONIBLE, PRETE, SUPPRIME)
 * @return La collection (ArrayList) correspondant � tous les exemplaires dont le statut est celui pass� en param�tres.
 */
